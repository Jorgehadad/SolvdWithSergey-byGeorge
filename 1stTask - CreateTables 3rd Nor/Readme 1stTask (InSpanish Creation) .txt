...
Normalization of  DB (3 normal forms):
https://www.guru99.com/database-normalization.html


2) Practical tasks

Create a database schema using Mysql Workbench for the new hierarchy (not one which was implemented in Java block) with at least 12 tables and all relations.
